    ...
    qubetLabel(NULL)
{
    ...
    labelsList.append(QPair<QString,GLuint>("survivor", BUTTON_PLAY_SURVIVOR));
        ...
        glPushMatrix();
            ...
            case MENU_SECTION:
                ...
                glPushMatrix();
                    ...
                    glTranslatef(3.0f, -4.0f, 0.0f);
                    if (gameType == STORY_MODE || gameType == SURVIVOR_MODE)
...
GLvoid Menu::buttonPlaySurvivorTriggered()
{
    if (currentView == MAIN_VIEW)
    {
...
void Menu::itemClicked(QMouseEvent *event, QList<GLuint> listNames)
{
    ...
    if (!listNames.isEmpty())
    {
        ...
        case BUTTON_PLAY_SURVIVOR:
            buttonPlaySurvivorTriggered();
            break;
