...
public:
     ...
     *
     * @param _cube is the cube Object pointer.
     * @param _obstacleCells is the obstacleCells Object pointer.
     * @param _parent is the parent Object pointer.
    */
    explicit PositionController(Cube *_cube, QVector<QVector<QVector<bool> > > _obstacleCells, QObject *_parent);
    ...
    /**
     * @brief set _obstacleCells as obstacleCells
    */
    void setObstacleCells(QVector<QVector<QVector<bool> > > _obstacleCells);
