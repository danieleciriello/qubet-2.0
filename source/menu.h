...
private:
    ...
    */
    ...
    /**
     * @brief This function is invoked when playSurvivorButton is triggered.
    */
    GLvoid buttonPlaySurvivorTriggered();
...
signals:
    ...
    /**
     * @brief Signal emitted to show the gameView in survivor mode.
     *
     * @param skinId
     */
    void playSurvivor(GLint skinId);
